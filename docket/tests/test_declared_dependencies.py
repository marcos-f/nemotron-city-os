...
This file exists because of a specific, reproduced failure. `docket` imports
throughline at module scope (docket/app.py:8 and docket/cli.py), throughline is
...
FIX = (
    ...
    "    bash scripts/fetch-substrate.sh /tmp/throughline && pip install /tmp/throughline\n"
    "    pip install -e '.[dev]'\n"
